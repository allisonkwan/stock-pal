...
/*
  ...
  // useEffect(() => {
  //   updateMentionsData(radioButtons);
  // }, [radioButtons]);
  ...
  function filterChart(time) {
    ...
    console.log("before filter chart");
    console.log(mentionsData);
    const dataPoints = [];
    ...
    console.log("data points being passed");
    ...
    // console.log("before ending filterChart");
  ...
  //   function filterChart(time, mentionsData) {

  // }

  // function updateData(mentionsData, testData) {
  //   console.log("in update data");
  //   dataPoints = testData.datasets[0].data;
  //   newData = [];
  ...
  //   console.log("CHECK 1");
  //   timestamps.forEach(timestamp => newData.push(new DataPoint(timestamp, mentionsData[0])));

  //   console.log("CHECK 2");
  //   setTestData({...testData, datasets: {...testData.datasets, data: newData}});

  //   console.log("Later test data");
  //   console.log(testData);
  // }

  // useEffect(() => {
  //   updateData(mentionsData, testData);}, [mentionsData]);
  }
  ...
  console.log(testData.datasets[0].data);
  // const modifiedData = {...testData.datasets[0].data};
